...
public abstract class HttpUtil {
    ...
    public static String httpGetRequest(String url, Object data) {
        return httpRequest(url, data, HttpMethods.GET, DEFAULT_TIME_OUT, NO_RETRY);
    }
    ...
    private static String genParamGet(Object obj) {
        StringBuilder sb = new StringBuilder();
        Map<String, Object> paramMap = genParamMap(obj);
        if(!paramMap.isEmpty()) {
            sb.append('?');
        }
